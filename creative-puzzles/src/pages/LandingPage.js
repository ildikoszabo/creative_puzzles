...
import { complementaryLightBg, complementaryMainBg, footerStyle } from '../common/appTheme';
...
export default function LandingPage() {
  return (
    <div>
      ...
      <section class="c-fx-column games-section" style={complementaryMainBg} id="games">
        <div>
          <h2>Try one of these games now</h2>
        </div>
        <div class="c-fx-space-around c-fx-row project-container">
          <div class="project-card">
            <img class="project-image" src={game_picture} alt="Infinity puzzle" />
      ...
      <section id="contact-me" style={complementaryMainBg} className="c-fx-row contact-me">
